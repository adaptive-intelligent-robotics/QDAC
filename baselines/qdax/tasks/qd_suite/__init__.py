from baselines.qdax.tasks.qd_suite.archimedean_spiral import (
    ArchimedeanBD,
    ArchimedeanSpiralV0,
    ParameterizationGenotype,
)
from baselines.qdax.tasks.qd_suite.deceptive_evolvability import DeceptiveEvolvabilityV0
from baselines.qdax.tasks.qd_suite.ssf import SsfV0
