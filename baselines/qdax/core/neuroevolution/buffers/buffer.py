...
from baselines.qdax.types import Action, Done, Observation, Reward, RNGKey, StateDescriptor, Descriptor
...
class ReplayBuffer(flax.struct.PyTreeNode):
    ...
    def insert(self, transitions: Transition) -> ReplayBuffer:
        ...
        print(jax.tree_map(lambda x: x.shape, flattened_transitions))
